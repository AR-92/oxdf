...
5555 came back filtered, which means I can't connect to it, but it's
...
Enumerating this port, it's actually the `listPics` command that helps
for Explore:
...
[![](/img/creds.jpg)](/img/creds.jpg)


[*Click for full ![image*](/img/creds.jpg)
