...
Now I can check `http://127.0.0.1` on my local Firefox (turning off the
proxy through Squid):
...
![](/img/image-20200820161648754.png)
...
Then I checked Google (and found nothing) and VirusTotal, where I found
it:
