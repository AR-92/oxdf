...
Without having to know much about what's going on in the transcript
...
I'll start with a basic `msfvenom` reverse shell payload as a dll.
...
This isn't that remarkable, except that I recognized this:
