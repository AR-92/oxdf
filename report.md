...
When I open the document, it's got a classic image suggesting that I've
...
No macro in this workbook will run. Any time I try to start, that
...
Additionally, the third arg, `s` is basically a length check. Why is
