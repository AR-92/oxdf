...
Visiting the site by IP returns a message about the Virtualhost not
being available:
...
Unfortunately, I can't seem to get anything to connect back to me. I
...
That `memcmp` compares two strings - the input stream and `magic`, the
