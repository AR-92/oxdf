...
This box has been released on HackTheBox directly to retired as a chance
...
With `nc` listening on 9001, I'll run the exploit again. It fetches
`poc.xml` (twice):
...
The nginx config looks a lot like before, but this time with an
