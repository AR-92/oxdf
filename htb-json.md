...
If I change my Burp proxy to intercept requests for `.js` files, and
...
If I then let the next request come through, I'm redirected to the
login.
...
If it doesn't, that's because I put in information for the server on
