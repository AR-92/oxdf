...
[![](/img/image-20200719141516090.png)](/img/image-20200719141516090.png)


[*Click for full
![image*](/img/image-20200719141516090.png)
...
Visiting `/upload.php` returns an error about a missing parameter `id`,
...
Next, I need the content type header to be of an image. This is easy,
since I set it:
...
for full size
![image*](/img/image-20200720215933378.png)
...
for full size
![image*](/img/image-20200721074446821.png)
