...
When I select "Repo by URL", I'm given the chance to input a URL, and
...
[![](/img/image-20210409220719648.png)*Click
for full size
...
Instead of running commands, I could also mount the host filesystem.
