...
![](/img/image-20200606150936265.png)
...
So when I look at my permissions locally on POO_CONFIG with the current
...
So now I can use p00_adm's account and add it to the Domain Admins
