...
Inside the `App` class, each of the variables I care about have a `get`
and a `set` method:
...
I'll add the decode to the script and then write the results to a file.
...
![](/img/image-20201027134906660.png)
