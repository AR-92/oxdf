...
Trying to post a comment leads to the log in page (`login.php`). There
...
![](/img/image-20230330162603596.png)
...
![](/img/image-20230330162659784.png)
...
Since I want to write a webshell, I'll want to write to the webroot.
